            ...
            <form action="#">
              <div class="table-content wnro__table table-responsive">
                <table>
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM `tblhoadon` WHERE `email` = '" . $_SESSION['email'] . "'");
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="product-price"><span class="amount"><?php echo number_format($row['TongTien'], 0, ",", ","); ?> đ</span></td>
                        </td>
                        <td class="product-subtotal"><?php echo $row['TinhTrang']; ?></td>
                        <!-- < -->
                        <td class="product-price"><a href="getthongtin.php?id=<?php echo $row['MaHD']; ?>">Xem chi tiết</a></td>
                      </tr>
                    <?php  } ?>
